...
[Documentation](../../../../../README.md) / [@6edesign/microservice](../../../README.md) / [](../../../README.md) / [z](../README.md) / ZodUndefined

# Class: ZodUndefined

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:427

## Extends

- [`Schema`](Schema.md)&lt;`undefined`, [`ZodUndefinedDef`](../interfaces/ZodUndefinedDef.md), `undefined`&gt;
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:429
...
```ts
spa: (data, params?) => Promise<SafeParseReturnType<undefined, undefined>>;
```
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:430
...
```ts
_parse(input): ParseReturnType<undefined>;
```

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:428
...
```ts
_parseAsync(input): AsyncParseReturnType<undefined>;
```
...
```ts
_parseSync(input): SyncParseReturnType<undefined>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodUndefined`, `undefined`, `undefined`&gt;
...
[`ZodBranded`](ZodBranded.md)&lt;`ZodUndefined`, `B`&gt;
...
[`ZodPipeline`](ZodPipeline.md)&lt;`ZodUndefined`, `T`&gt;
...
[`ZodPromise`](ZodPromise.md)&lt;`ZodUndefined`&gt;
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodUndefined`, `RefinedOutput`, `undefined`&gt;
...
```ts
safeParse(data, params?): SafeParseReturnType<undefined, undefined>;
```
...
```ts
safeParseAsync(data, params?): Promise<SafeParseReturnType<undefined, undefined>>;
```
...
```ts
transform<NewOut>(transform): ZodEffects<ZodUndefined, NewOut>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodUndefined`, `NewOut`&gt;
