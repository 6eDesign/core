...
[Documentation](../../../../../README.md) / [@6edesign/microservice](../../../README.md) / [](../../../README.md) / [z](../README.md) / ZodDefault

# Class: ZodDefault&lt;T&gt;

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:849

## Extends

- [`Schema`](Schema.md)&lt;[`noUndefined`](../namespaces/util/type-aliases/noUndefined.md)&lt;`T`\[`"_output"`\]&gt;, [`ZodDefaultDef`](../interfaces/ZodDefaultDef.md)&lt;`T`&gt;, `T`\[`"_input"`\] \| `undefined`&gt;
...
```ts
~standard: Props<undefined | T["_input"], noUndefined<T["_output"]>>;
```
...
```ts
static create: <Inner>(type, params) => ZodDefault<Inner>;
```

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:852
...
```ts
_parse(input): ParseReturnType<noUndefined<T["_output"]>>;
```

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:850
...
```ts
_parseAsync(input): AsyncParseReturnType<noUndefined<T["_output"]>>;
```
...
```ts
_parseSync(input): SyncParseReturnType<noUndefined<T["_output"]>>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodDefault`&lt;`T`&gt;, [`noUndefined`](../namespaces/util/type-aliases/noUndefined.md)&lt;`T`\[`"_output"`\]&gt;, `undefined` \| `T`\[`"_input"`\]&gt;
...
```ts
~validate(data): 
  | Result<noUndefined<T["_output"]>>
  | Promise<Result<noUndefined<T["_output"]>>>;
```
...
#### Returns
  ...
  \| `Result`&lt;[`noUndefined`](../namespaces/util/type-aliases/noUndefined.md)&lt;`T`\[`"_output"`\]&gt;&gt;
  \| `Promise`&lt;`Result`&lt;[`noUndefined`](../namespaces/util/type-aliases/noUndefined.md)&lt;`T`\[`"_output"`\]&gt;&gt;&gt;
...
[`ZodBranded`](ZodBranded.md)&lt;`ZodDefault`&lt;`T`&gt;, `B`&gt;
...
[`noUndefined`](../namespaces/util/type-aliases/noUndefined.md)
...
(`ctx`) => [`noUndefined`](../namespaces/util/type-aliases/noUndefined.md)
...
[`ZodPipeline`](ZodPipeline.md)&lt;`ZodDefault`&lt;`T`&gt;, `T`&gt;
...
[`ZodPromise`](ZodPromise.md)&lt;`ZodDefault`&lt;`T`&gt;&gt;
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodDefault`&lt;`T`&gt;, `RefinedOutput`, `undefined` \| `T`\[`"_input"`\]&gt;
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:851
...
```ts
safeParse(data, params?): SafeParseReturnType<undefined | T["_input"], noUndefined<T["_output"]>>;
```
...
```ts
safeParseAsync(data, params?): Promise<SafeParseReturnType<undefined | T["_input"], noUndefined<T["_output"]>>>;
```
...
```ts
transform<NewOut>(transform): ZodEffects<ZodDefault<T>, NewOut>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodDefault`&lt;`T`&gt;, `NewOut`&gt;
