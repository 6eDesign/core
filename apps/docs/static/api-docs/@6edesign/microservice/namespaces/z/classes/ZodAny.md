...
[Documentation](../../../../../README.md) / [@6edesign/microservice](../../../README.md) / [](../../../README.md) / [z](../README.md) / ZodAny

# Class: ZodAny

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:442

## Extends

- [`Schema`](Schema.md)&lt;`any`, [`ZodAnyDef`](../interfaces/ZodAnyDef.md), `any`&gt;
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:443
...
```ts
spa: (data, params?) => Promise<SafeParseReturnType<any, any>>;
```
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:445
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:444
...
```ts
_parseAsync(input): AsyncParseReturnType<any>;
```
...
```ts
_parseSync(input): SyncParseReturnType<any>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodAny`, `any`, `any`&gt;
...
[`ZodBranded`](ZodBranded.md)&lt;`ZodAny`, `B`&gt;
...
[`ZodPipeline`](ZodPipeline.md)&lt;`ZodAny`, `T`&gt;
...
[`ZodPromise`](ZodPromise.md)&lt;`ZodAny`&gt;
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodAny`, `RefinedOutput`, `any`&gt;
...
```ts
safeParse(data, params?): SafeParseReturnType<any, any>;
```
...
```ts
safeParseAsync(data, params?): Promise<SafeParseReturnType<any, any>>;
```
...
```ts
transform<NewOut>(transform): ZodEffects<ZodAny, NewOut>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodAny`, `NewOut`&gt;
