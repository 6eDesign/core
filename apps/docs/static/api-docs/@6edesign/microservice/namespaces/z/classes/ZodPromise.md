...
[Documentation](../../../../../README.md) / [@6edesign/microservice](../../../README.md) / [](../../../README.md) / [z](../README.md) / ZodPromise

# Class: ZodPromise&lt;T&gt;

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:791

## Extends

- [`Schema`](Schema.md)&lt;`Promise`&lt;`T`\[`"_output"`\]&gt;, [`ZodPromiseDef`](../interfaces/ZodPromiseDef.md)&lt;`T`&gt;, `Promise`&lt;`T`\[`"_input"`\]&gt;&gt;
...
```ts
static create: <Inner>(schema, params?) => ZodPromise<Inner>;
```

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:794
...
```ts
_parse(input): ParseReturnType<Promise<T["_output"]>>;
```

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:793
...
```ts
_parseAsync(input): AsyncParseReturnType<Promise<T["_output"]>>;
```
...
```ts
_parseSync(input): SyncParseReturnType<Promise<T["_output"]>>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodPromise`&lt;`T`&gt;, `Promise`&lt;`T`\[`"_output"`\]&gt;, `Promise`&lt;`T`\[`"_input"`\]&gt;&gt;
...
```ts
~validate(data): 
  | Result<Promise<T["_output"]>>
  | Promise<Result<Promise<T["_output"]>>>;
```
...
[`ZodBranded`](ZodBranded.md)&lt;`ZodPromise`&lt;`T`&gt;, `B`&gt;
...
[`ZodPipeline`](ZodPipeline.md)&lt;`ZodPromise`&lt;`T`&gt;, `T`&gt;
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodPromise`&lt;`T`&gt;, `RefinedOutput`, `Promise`&lt;`T`\[`"_input"`\]&gt;&gt;
...
```ts
safeParse(data, params?): SafeParseReturnType<Promise<T["_input"]>, Promise<T["_output"]>>;
```
...
```ts
safeParseAsync(data, params?): Promise<SafeParseReturnType<Promise<T["_input"]>, Promise<T["_output"]>>>;
```
...
```ts
transform<NewOut>(transform): ZodEffects<ZodPromise<T>, NewOut>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodPromise`&lt;`T`&gt;, `NewOut`&gt;
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:792
