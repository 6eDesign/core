...
[Documentation](../../../../../README.md) / [@6edesign/microservice](../../../README.md) / [](../../../README.md) / [z](../README.md) / ZodLazy

# Class: ZodLazy&lt;T&gt;

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:731

## Extends

- [`Schema`](Schema.md)&lt;[`output`](../type-aliases/output.md)&lt;`T`&gt;, [`ZodLazyDef`](../interfaces/ZodLazyDef.md)&lt;`T`&gt;, [`input`](../type-aliases/input.md)&lt;`T`&gt;&gt;
...
```ts
spa: (data, params?) => Promise<SafeParseReturnType<input<T>, output<T>>>;
```
...
```ts
static create: <Inner>(getter, params?) => ZodLazy<Inner>;
```

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:734
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:732
...
```ts
_parse(input): ParseReturnType<output<T>>;
```

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:733
...
```ts
_parseAsync(input): AsyncParseReturnType<output<T>>;
```
...
```ts
_parseSync(input): SyncParseReturnType<output<T>>;
```
...
```ts
_refinement(refinement): ZodEffects<ZodLazy<T>, output<T>, input<T>>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodLazy`&lt;`T`&gt;, [`output`](../type-aliases/output.md)&lt;`T`&gt;, [`input`](../type-aliases/input.md)&lt;`T`&gt;&gt;
...
#### Returns
  ...
  \| `Result`&lt;[`output`](../type-aliases/output.md)&lt;`T`&gt;&gt;
  \| `Promise`&lt;`Result`&lt;[`output`](../type-aliases/output.md)&lt;`T`&gt;&gt;&gt;
...
[`ZodBranded`](ZodBranded.md)&lt;`ZodLazy`&lt;`T`&gt;, `B`&gt;
...
```ts
parseAsync(data, params?): Promise<output<T>>;
```
...
[`ZodPipeline`](ZodPipeline.md)&lt;`ZodLazy`&lt;`T`&gt;, `T`&gt;
...
[`ZodPromise`](ZodPromise.md)&lt;`ZodLazy`&lt;`T`&gt;&gt;
...
```ts
refine<RefinedOutput>(check, message?): ZodEffects<ZodLazy<T>, RefinedOutput, input<T>>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodLazy`&lt;`T`&gt;, `RefinedOutput`, [`input`](../type-aliases/input.md)&lt;`T`&gt;&gt;
...
```ts
refine(check, message?): ZodEffects<ZodLazy<T>, output<T>, input<T>>;
```
...
```ts
refinement<RefinedOutput>(check, refinementData): ZodEffects<ZodLazy<T>, RefinedOutput, input<T>>;
```
...
```ts
refinement(check, refinementData): ZodEffects<ZodLazy<T>, output<T>, input<T>>;
```
...
```ts
safeParse(data, params?): SafeParseReturnType<input<T>, output<T>>;
```
...
```ts
safeParseAsync(data, params?): Promise<SafeParseReturnType<input<T>, output<T>>>;
```
...
```ts
superRefine<RefinedOutput>(refinement): ZodEffects<ZodLazy<T>, RefinedOutput, input<T>>;
```
...
```ts
superRefine(refinement): ZodEffects<ZodLazy<T>, output<T>, input<T>>;
```
...
```ts
transform<NewOut>(transform): ZodEffects<ZodLazy<T>, NewOut>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodLazy`&lt;`T`&gt;, `NewOut`&gt;
