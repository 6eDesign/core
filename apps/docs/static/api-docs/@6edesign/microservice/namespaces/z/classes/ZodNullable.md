...
[Documentation](../../../../../README.md) / [@6edesign/microservice](../../../README.md) / [](../../../README.md) / [z](../README.md) / ZodNullable

# Class: ZodNullable&lt;T&gt;

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:839

## Extends

- [`Schema`](Schema.md)&lt;`T`\[`"_output"`\] \| `null`, [`ZodNullableDef`](../interfaces/ZodNullableDef.md)&lt;`T`&gt;, `T`\[`"_input"`\] \| `null`&gt;
...
```ts
static create: <Inner>(type, params?) => ZodNullable<Inner>;
```

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:842
...
```ts
_parse(input): ParseReturnType<null | T["_output"]>;
```

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:840
...
```ts
_parseAsync(input): AsyncParseReturnType<null | T["_output"]>;
```
...
```ts
_parseSync(input): SyncParseReturnType<null | T["_output"]>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodNullable`&lt;`T`&gt;, `null` \| `T`\[`"_output"`\], `null` \| `T`\[`"_input"`\]&gt;
...
```ts
~validate(data): 
  | Result<null | T["_output"]>
  | Promise<Result<null | T["_output"]>>;
```
...
[`ZodBranded`](ZodBranded.md)&lt;`ZodNullable`&lt;`T`&gt;, `B`&gt;
...
[`ZodPipeline`](ZodPipeline.md)&lt;`ZodNullable`&lt;`T`&gt;, `T`&gt;
...
[`ZodPromise`](ZodPromise.md)&lt;`ZodNullable`&lt;`T`&gt;&gt;
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodNullable`&lt;`T`&gt;, `RefinedOutput`, `null` \| `T`\[`"_input"`\]&gt;
...
```ts
safeParse(data, params?): SafeParseReturnType<null | T["_input"], null | T["_output"]>;
```
...
```ts
safeParseAsync(data, params?): Promise<SafeParseReturnType<null | T["_input"], null | T["_output"]>>;
```
...
```ts
transform<NewOut>(transform): ZodEffects<ZodNullable<T>, NewOut>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodNullable`&lt;`T`&gt;, `NewOut`&gt;
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:841
