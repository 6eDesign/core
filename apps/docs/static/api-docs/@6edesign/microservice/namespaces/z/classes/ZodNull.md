...
[Documentation](../../../../../README.md) / [@6edesign/microservice](../../../README.md) / [](../../../README.md) / [z](../README.md) / ZodNull

# Class: ZodNull

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:435

## Extends

- [`Schema`](Schema.md)&lt;`null`, [`ZodNullDef`](../interfaces/ZodNullDef.md), `null`&gt;
...
```ts
spa: (data, params?) => Promise<SafeParseReturnType<null, null>>;
```
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:437
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:436
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodNull`, `null`, `null`&gt;
...
[`ZodBranded`](ZodBranded.md)&lt;`ZodNull`, `B`&gt;
...
[`ZodPipeline`](ZodPipeline.md)&lt;`ZodNull`, `T`&gt;
...
[`ZodPromise`](ZodPromise.md)&lt;`ZodNull`&gt;
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodNull`, `RefinedOutput`, `null`&gt;
...
```ts
transform<NewOut>(transform): ZodEffects<ZodNull, NewOut>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodNull`, `NewOut`&gt;
