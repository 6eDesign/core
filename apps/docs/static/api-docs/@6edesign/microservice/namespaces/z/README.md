...
[Documentation](../../../../README.md) / [@6edesign/microservice](../../README.md) / [](../../README.md) / z
...
- [defaultErrorMap](variables/defaultErrorMap.md)
- [DIRTY](variables/DIRTY.md)
- [discriminatedUnion](variables/discriminatedUnion.md)
...
- [instanceof](variables/instanceof.md)
- [intersection](variables/intersection.md)
- [INVALID](variables/INVALID.md)
- [isAborted](variables/isAborted.md)
- [isAsync](variables/isAsync.md)
- [isDirty](variables/isDirty.md)
- [isValid](variables/isValid.md)
- [late](variables/late.md)
- [lazy](variables/lazy.md)
- [literal](variables/literal.md)
- [makeIssue](variables/makeIssue.md)
- [map](variables/map.md)
- [nan](variables/nan.md)
- [nativeEnum](variables/nativeEnum.md)
- [never](variables/never.md)
- [NEVER](variables/NEVER-1.md)
- [null](variables/null.md)
- [nullable](variables/nullable.md)
- [number](variables/number.md)
- [object](variables/object.md)
- [oboolean](variables/oboolean.md)
- [OK](variables/OK.md)
- [onumber](variables/onumber.md)
- [optional](variables/optional.md)
- [ostring](variables/ostring.md)
- [pipeline](variables/pipeline.md)
- [preprocess](variables/preprocess.md)
- [promise](variables/promise.md)
- [quotelessJson](variables/quotelessJson.md)
- [record](variables/record.md)
- [set](variables/set.md)
- [strictObject](variables/strictObject.md)
- [string](variables/string.md)
- [symbol](variables/symbol.md)
- [tuple](variables/tuple.md)
- [undefined](variables/undefined.md)
- [union](variables/union.md)
...
Renames and re-exports [effect](variables/effect.md)

***

### ZodSchema

Renames and re-exports [Schema](classes/Schema.md)
