...
[Documentation](../../../../../README.md) / [@6edesign/microservice](../../../README.md) / [](../../../README.md) / [z](../README.md) / ZodIntersection

# Class: ZodIntersection&lt;T, U&gt;

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:634

## Extends

- [`Schema`](Schema.md)&lt;`T`\[`"_output"`\] & `U`\[`"_output"`\], [`ZodIntersectionDef`](../interfaces/ZodIntersectionDef.md)&lt;`T`, `U`&gt;, `T`\[`"_input"`\] & `U`\[`"_input"`\]&gt;
...
```ts
readonly _def: ZodIntersectionDef;
```
...
```ts
static create: <TSchema, USchema>(left, right, params?) => ZodIntersection<TSchema, USchema>;
```

Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:636
...
Defined in: node\_modules/.pnpm/zod@3.25.76/node\_modules/zod/v3/types.d.cts:635
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;, `T`\[`"_output"`\] & `U`\[`"_output"`\], `T`\[`"_input"`\] & `U`\[`"_input"`\]&gt;
...
```ts
~validate(data): 
  | Result<T["_output"] & U["_output"]>
  | Promise<Result<T["_output"] & U["_output"]>>;
```
...
```ts
array(): ZodArray<ZodIntersection<T, U>>;
```
...
[`ZodArray`](ZodArray.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;&gt;
...
[`ZodBranded`](ZodBranded.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;, `B`&gt;
...
[`ZodCatch`](ZodCatch.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;&gt;
...
[`ZodDefault`](ZodDefault.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;&gt;
...
[`ZodNullable`](ZodNullable.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;&gt;
...
[`ZodOptional`](ZodOptional.md)&lt;[`ZodNullable`](ZodNullable.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;&gt;&gt;
...
[`ZodOptional`](ZodOptional.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;&gt;
...
[`ZodUnion`](ZodUnion.md)&lt;\[`ZodIntersection`&lt;`T`, `U`&gt;, `T`\]&gt;
...
[`ZodPipeline`](ZodPipeline.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;, `T`&gt;
...
[`ZodPromise`](ZodPromise.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;&gt;
...
[`ZodReadonly`](ZodReadonly.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;&gt;
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;, `RefinedOutput`, `T`\[`"_input"`\] & `U`\[`"_input"`\]&gt;
...
```ts
transform<NewOut>(transform): ZodEffects<ZodIntersection<T, U>, NewOut>;
```
...
[`ZodEffects`](ZodEffects.md)&lt;`ZodIntersection`&lt;`T`, `U`&gt;, `NewOut`&gt;
